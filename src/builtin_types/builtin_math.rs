...
fn create_function_1arg<FFloat>(runtime: &mut Runtime, name: &str, 
        ...
        code: Box::new(move |runtime, params| -> MemoryAddress {
            ...
            return match value_type_name {
                "int" => {
                    ...
                    runtime.allocate_builtin_type_byname_raw("float", BuiltInTypeData::Float(Float((op_float)(parameter as f64))))
                },
                "float" => {
                    let other_float = other_value.take_float();
                    runtime.allocate_builtin_type_byname_raw("float", BuiltInTypeData::Float(Float((op_float)(other_float))))
                },
                _ => {
